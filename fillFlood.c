...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
	...
	if (nrhs != 9)
	{
		printf("Usage: fillFlood(image,re_image,mask,re_mask,point,stack1,stack2,imgstack)\n");
		return;
	}
